...
// COPSBootstrapper.LiveCheck — developer smoke-check for the display stack against real hardware.
...
if (File.Exists(COPSBootstrapper.Driver.Providers.MttVddProvider.DefaultSettingsPath))
{
    var doc = VddSettingsDocument.Load(COPSBootstrapper.Driver.Providers.MttVddProvider.DefaultSettingsPath);
