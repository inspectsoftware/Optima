namespace COPSBootstrapper.Core.Configuration;

/// <summary>Well-known storage locations (§21). Everything lives under %LOCALAPPDATA%\COPSBootstrapper.</summary>
public sealed class AppPaths
{
    public AppPaths() : this(Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "COPSBootstrapper"))
    {
    }
