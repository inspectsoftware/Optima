...
using COPSBootstrapper.App.Logging;
...
namespace COPSBootstrapper.App;
...
public partial class App : Application
{
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        Log.Logger = new LoggerConfiguration()
            ...
            .WriteTo.File(
                System.IO.Path.Combine(paths.LogsDirectory, "cops-.log"),
        ...
        _host.Start();
        Log.Information("COPS Bootstrapper starting (version {Version})",
    ...
    private void OnDispatcherUnhandledException(object sender, DispatcherUnhandledExceptionEventArgs e)
    {
        ...
        TryEmergencyRestore();
        MessageBox.Show(
            "COPS Bootstrapper hit an unexpected error and will close.\n\n" +
            "Any temporary system changes have been rolled back. Details were written to the log folder.",
            "COPS Bootstrapper", MessageBoxButton.OK, MessageBoxImage.Error);
        e.Handled = true;
        Shutdown(1);
    }
    ...
    protected override void OnExit(ExitEventArgs e)
    {
        ...
        Log.Information("COPS Bootstrapper exited");
        Log.CloseAndFlush();
        base.OnExit(e);
    }
}
