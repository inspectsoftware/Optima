...
using static COPSBootstrapper.Platform.Windows.NativeMethods.DisplayNative;
...
public sealed class WindowsDisplayService : IDisplayService
{
    ...
    public Task MakePrimaryAsync(string deviceName, CancellationToken ct = default)
        => Task.Run(() =>
        {
            ...
            {
                throw CopsException.From("DISPLAY_NOT_ACTIVE",
            ...
            {
                throw CopsException.From("DISPLAY_PRIMARY_FAILED",
